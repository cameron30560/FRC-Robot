...
public class Drivesubsystem extends SubsystemBase {
  public static VictorSPX lF = new VictorSPX(0);
  public static VictorSPX lB = new VictorSPX(1);
  public static VictorSPX rF = new VictorSPX(2);
  public static VictorSPX rB = new VictorSPX(3);
